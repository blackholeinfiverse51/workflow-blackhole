...
**Password:** Set via `TEST_USER_PASSWORD` environment variable (or generated by create_test_user.js)  
**User ID:** Check output of create_test_user.js
...
- **Solution:** Check password matches the one generated by create_test_user.js (case-sensitive)
